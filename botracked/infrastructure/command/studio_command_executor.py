...
class StudioCommandExecutor:
    ...
    def __init__(self, definition: StudioCommandDefinition, gui: BotrackedGUI) -> None:
        '''
    ...
    def execute(self, *, params: Mapping[str, object], service: BotService) -> Mapping[str, object]:
        '''
            Launches GUI window.
