...
htmlhelp_basename: str = 'botrackeddoc'
latex_elements: dict[object, object] = {}
latex_documents: list[tuple[object, ...]] = [(
    root_doc, 'botracked.tex', 'botracked Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[object, ...]] = [(
    root_doc, 'botracked', 'botracked Documentation', [author], 1
)]
texinfo_documents: list[tuple[object, ...]] = [(
    root_doc, 'botracked', 'botracked Documentation', author, 'botracked',
    'Tracked robot navigation cockpit, telemetry monitor, and mission scripting suite.', 'Miscellaneous'
)]
