...
Info
    Defines setup for botracked package.
'''
...
setup(
    name='botracked',
    version='1.0.0',
    description='Tracked Robot Navigation Cockpit, Telemetry Monitor and Mission Scripting Suite.',
    author='Vladimir Roncevic',
    author_email='elektron.ronca@gmail.com',
    url='https://github.com/vroncevic/botracked',
    license='GNU General Public License (GPL)',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='tracked-robot, telemetry, cockpit, dsl, motion-control, robotics, serial-streamer',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=find_packages(exclude=['tests', 'tests.*', '*.*.pyc', '*.pyo']),
    py_modules=['main'],
    install_requires=['ats-utilities', 'pyserial'],
    package_data={'botracked': find_package_data('botracked')},
    entry_points={
        'console_scripts': [
            'botracked=main:main'
        ]
